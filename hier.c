...
void hier()
{
  ...
  c(auto_qmail,"bin","queue-fix",auto_uido,auto_gidq,0755);
  ...
  c(auto_qmail,"man/man8","queue-fix.8",auto_uido,auto_gidq,0644);
  c(auto_qmail,"man/cat8","queue-fix.0",auto_uido,auto_gidq,0644);
}
